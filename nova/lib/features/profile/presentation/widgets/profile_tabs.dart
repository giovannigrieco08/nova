...
class ProfileTabs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (Platform.isIOS) {
      return _buildIOSTabs();
    } else {
      return _buildAndroidTabs();
    }
  }

  /// Build iOS tabs with CupertinoSegmentedControl
  Widget _buildIOSTabs() {
    ...
    return Padding(
      ...
      child: CupertinoSegmentedControl<ProfileTab>(
        ...
        unselectedColor: NovaColors.backgroundSecondary,
        borderColor: NovaColors.borderPrimary,
  ...
  Widget _buildAndroidTabs() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(
            color: NovaColors.borderPrimary,
            width: 1,
          ),
        ),
      ),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Text(
            label,
            style: NovaTypography.bodyMedium.copyWith(
              color: isSelected ? NovaColors.brandViolet : NovaColors.textSecondary,
