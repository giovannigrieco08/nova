...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
    ...
    return AdaptiveScaffold(
      ...
      body: ListView(
        children: [
          ...
          // Section 4: Moderazione (only if moderator)
  ...
  Widget _buildNotificationsSection(Profile profile) {
    // TODO(T072): Implement notification preferences (stored in user_preferences table)
    // For now, hardcode to ON
    final notificationsEnabled = true;
    final chatNotificationsEnabled = true;
    final moderationNotificationsEnabled = profile.isModerator;
      ...
      child: Column(
        children: [
          _buildSwitchTile(
            ...
            subtitle: 'Nuovi eventi, aggiornamenti',
            value: notificationsEnabled,
            onChanged: (value) {
              // TODO(T072): Update notification preference
            },
          ),
          _buildDivider(),
          _buildSwitchTile(
            icon: Icons.chat_rounded,
            title: 'Notifiche chat',
            subtitle: 'Messaggi nella chat globale',
          ...
          if (profile.isModerator) ...[
            ...
            _buildSwitchTile(
              ...
              title: 'Notifiche moderazione',
              subtitle: 'Eventi in coda di moderazione',
              value: moderationNotificationsEnabled,
              onChanged: (value) {
                // TODO(T072): Update notification preference
              },
            ),
  ...
  Widget _buildReadOnlyTile({
    ...
    return ListTile(
      leading: Icon(icon, color: NovaColors.textSecondary),
  ...
  Widget _buildSwitchTile({
    ...
    return ListTile(
      leading: Icon(icon, color: NovaColors.textPrimary),
      title: Text(title, style: NovaTypography.bodyMedium),
      subtitle: Text(
        subtitle,
        style: NovaTypography.bodySmall.copyWith(
  ...
  Widget _buildActionTile({
    ...
    final titleColor = isDestructive ? NovaColors.error : NovaColors.textPrimary;
    ...
    return ListTile(
      ...
      subtitle: subtitle != null
          ? Text(
              ...
              style: NovaTypography.bodySmall.copyWith(
                color: isDestructive
                    ? NovaColors.error.withOpacity(0.7)
